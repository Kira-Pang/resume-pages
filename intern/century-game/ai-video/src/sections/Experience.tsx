...
const experiences = [
  ...
  },
  {
    ...
    title: '北京交通大学党委宣传部',
    subtitle: '学生电视台台长',
    description: '担任"一带一路"十周年主题 MV《万里当歌》摄像与现场协调总负责人。组织策划校内特别栏目《主播说交大》。',
  },
  {
    type: 'work',
    icon: Briefcase,
      ...
      <div ref={ref} className="max-w-4xl mx-auto px-6 md:px-12">
        ...
        <div className="relative">
          ...
          >
            ...
            <motion.path
              d="M12 0 C12 60 28 60 28 120 C28 180 12 180 12 240 C12 300 28 300 28 360 C28 420 12 420 12 480 C12 540 28 540 28 600 C28 660 12 660 12 720"
