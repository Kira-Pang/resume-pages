...
const projects: Project[] = [
  {
    ...
    icon: Sparkles,
    role: '项目负责人 / 创意策划 / AI 工作流搭建者',
    actions: [
      '使用 Kimi 辅助进行红包封面主题与风格构建',
      '生成每个宠物元素单独的生图 prompt 和所有元素整合 prompt',
      '使用 Doubao 生成清新风格的各元素 alpha 通道图片',
      '使用 Sora 和 Nano Banana 生成手绘风格的完整红包封面',
      '针对 AIGC 违反常识的问题（动物爪子不合理、牙齿像人），通过增加准确位置描述、具体限制词等方式调整 prompt',
    ],
