...
const projects: Project[] = [
  {
    ...
    role: '创意策划 / AI 工作流搭建者',
    actions: [
      '为制作新年应景红包封面，融合家养宠物形成个人特色，利用 Kimi 辅助进行红包封面主题与风格构建，生成每个宠物元素单独的生图 prompt 和所有元素整合 prompt，利用 Doubao 生成清新风格的各元素 alpha 通道图片，利用 Sora 和 Nano Banana 生成手绘风格的完整红包封面。为解决 AIGC 的违反常识的问题（如动物爪子不合理、牙齿像人），通过增加准确位置描述、具体限制词等方式调整 prompt，保证宠物形象可爱且具有高辨识度。',
    ],
  ...
  },
  {
    ...
    actions: [
      '基于产品受众确定视频风格以古典写意为主',
      '设计镜头序列：开篇卷轴+文字介绍 → 摇移镜头展示包装 → 推镜头展示产品细节',
      '解决产品实际冲泡较为浑浊影响画面观感的问题，通过对比多种饮料颜色，选择以力量帝橙味进行相似替代',
      '通过动静结合，旋转杯中水展示生命的活力',
      '最后接年轻女性剪影一饮而尽，含有回归年轻之意',
    ],
  ...
  },
  {
    id: '6',
    title: '学院公众号宣传物料设计',
    tags: ['公众号运营', '秀米排版', '海报设计', '创客贴', '宣传物料', '视觉设计'],
    icon: Palette,
    role: '宣传部副部长 / 设计师',
    actions: [
      '负责学院公众号"悟理功成"的运营管理',
    ...
    result: '',
    abilities: ['公众号运营', '图文排版', '海报设计', '视觉审美'],
  },
  {
    id: '7',
