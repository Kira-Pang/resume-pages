      ...
      <div ref={ref} className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        >
          <button
            ...
            className="inline-flex items-center gap-2 px-6 py-3 border border-dashed border-[var(--morandi-border)] text-[var(--morandi-text-secondary)] rounded-full hover:border-[var(--morandi-accent)] hover:text-[var(--morandi-accent)] transition-all duration-300 font-body text-sm"
          >
